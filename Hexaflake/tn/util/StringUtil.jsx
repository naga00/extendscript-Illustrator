(function(){
    ...
    StringUtil.prototype.convertKana = function(filename) {
    ...
    StringUtil.prototype.convertKanaSub = function(srcName, code, count) {
        srcName = srcName.replace(/%E3%82%BF%E3%82%99/g, "%E3%83%80");
